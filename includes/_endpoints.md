...
Method | Path | Description
--------- | ----------- | ---------
GET | /api/v1/account | Retrieve a list of accounts
POST | /api/v1/account | Create a new account.
GET | /api/v1/account/{id} | Retrieve a single account by ID.
PUT | /api/v1/account/{id} | Update an existing account.
DELETE | /api/v1/account/{id} | Update an existing account.
PUT | /api/v1/account/{id} | Delete an existing account.
GET | /api/v1/account/deactivate/{id} | Endpoint for retrievingassociated objects of an account that would be deactivated on a DELETE
DELETE | /api/v1/account/deactivate/{id} | Endpoint for deactivating associated objects of an account.
PUT | /api/v1/account/{id} | Update an existing account.
...
`https://api-demo.polestarglobal.com/api/v1/account/{path}/{id}'
